        ...
        n.length > 0 &&
            ($(".be-toggle-right-sidebar").on("click", function (t) {
                s && e.hasClass(v.openRightSidebarClass)
                    ? a()
                    : s ||
                    (e.addClass(v.openRightSidebarClass + " " + v.transitionClass),
                        (s = !0)),
                    t.preventDefault();
            }),
        ...
        function c(e, t) {
            ...
            "" != e &&
                ($('<div class="msg">' + e + "</div>").appendTo(i),
                    i.appendTo(n),
                    a.stop().animate({ scrollTop: a.prop("scrollHeight") }, 900, "swing"),
                    C(m));
        }
                    ...
                    ? (function () {
                        ...
                        t.hasClass(v.collapsibleSidebarClass) &&
                            ((a = void 0 !== n ? n : $(".sidebar-elements > li", o)),
                                ...
                                (function () {
                                    for (
                                        var e = $(".sidebar-elements > li > a", o), i = 0;
                                        i <= e.length;
                                        i++
                                    ) {
                                        var n = e[i],
                            ...
                            t.hasClass(v.collapsibleSidebarCollapsedClass)
                                ? $("li.active", o).parents(".parent").addClass("active")
                            ...
                            (l.on("click", function (t) {
                                s && e.hasClass(v.openLeftSidebarClass)
                                    ? (e.removeClass(v.openLeftSidebarClass), T())
                                    : (e.addClass(
                                        v.openLeftSidebarClass + " " + v.transitionClass
                                    ),
                                        (s = !0)),
                                    t.preventDefault();
                            }),
                    ...
                    e.forEach(function (e) {
                        "attributes" == e.type &&
                            ...
                            (document.body.className.indexOf("swal2-shown") > 0
                                ? i.css({
                                    marginLeft:
                                        "calc(-" + document.body.style.paddingRight + " / 2)",
                                })
                                : i.css({ marginLeft: "0" }));
                    });
...
(FastClick.prototype.needsClick = function (e) {
    ...
    (FastClick.notNeeded = function (e) {
        ...
        if (
            ...
            (o = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/))[1] >= 10 &&
            o[2] >= 3 &&
                        ...
                        ((_ = new (function (t, T) {
                            function _(t) {
                                if (
                                    !(
                                        ...
                                        e(t.target).closest(T.excludedElements, Ce).length > 0
                                    )
                                ) {
                                        ...
                                        return (
                                            ...
                                            !s || Se === T.fingers || T.fingers === b || Y()
                                                ? ((Ae = ae()),
                                                    ...
                                                    (T.swipeStatus || T.pinchStatus) && (l = D(r, $e)))
                                                : (l = !1),
                                            !1 === l
                                                ? (D(r, ($e = C)), l)
                                                : (T.hold &&
                                ...
                                if ($e !== y && $e !== C && !Q()) {
                                    ...
                                    if (
                                        ((Te = ae()),
                                            ...
                                            2 == Se &&
                                            (0 == me
                                                ? (Z(1, A[1]), (me = be = oe(xe[0].start, xe[1].start)))
                                                : (K(A[1]),
                                        ...
                                        if (
                                            ((he = ne(M.start, M.end)),
                                                ...
                                                (pe = Math.round(
                                                    Math.sqrt(
                                                        Math.pow($.x - w.x, 2) + Math.pow($.y - w.y, 2)
                                                    )
                                                )),
                                                (ge = ie()),
                                                (v = pe),
                                                (f = he) != s &&
                                                ((v = Math.max(v, ee(f))), (ye[f].distance = v)),
                                                (x = D(S, $e)),
                            ...
                            function E(e) {
                                ...
                                if (o) {
                                    if (o.length && !Q())
                                        return (
                                            (t = i), (_e = ae()), (Me = t.touches.length + 1), !0
                                        );
                                ...
                                return (
                                    !i || n
                                        ...
                                        : !o ||
                                            e != k ||
                                            (T.triggerOnTouchEnd && !T.triggerOnTouchLeave)
                                            ? !o && e == y && T.triggerOnTouchLeave && (t = C)
                                            : (t = y),
                                    t
                                );
                            }
                                    ...
                                    if (s == y && z()) {
                                        if (
                                            (clearTimeout(Pe),
                                                ...
                                                T.swipe &&
                                                !1 ===
                                                (g = T.swipe.call(Ce, t, he, pe, ge, Se, xe, fe)))
                                        )
                                            return !1;
                                        switch (he) {
                                            case i:
                                            ...
                                            case n:
                                                Ce.trigger("swipeUp", [he, pe, ge, Se, xe, fe]),
                                                    T.swipeUp &&
                                                    (g = T.swipeUp.call(Ce, t, he, pe, ge, Se, xe, fe));
                                                break;
                                            case a:
                                    ...
                                    c == p
                                        ...
                                        : c == h
                                            ...
                                            (clearTimeout(Pe),
                                                ...
                                                T.doubleTap && (g = T.doubleTap.call(Ce, t, t.target)))
                                            : c == f &&
                                            ((s !== C && s !== y) ||
                                                (clearTimeout(Pe),
                                                    (Ee = null),
                            ...
                            function J(e) {
                                Ce &&
                                    (!0 === e
                                        ? (Ce.bind(se, M), Ce.bind(ce, E), de && Ce.bind(de, B))
                                        : (Ce.unbind(se, M, !1),
                                            Ce.unbind(ce, E, !1),
                                            de && Ce.unbind(de, B, !1)),
                            ...
                            try {
                                ...
                                e.error(
                                    "events not supported " + le + "," + ue + " on jQuery.swipe"
                                );
                            }
    ...
    (function (e) {
                            ...
                            : T(n.h) && T(n.s) && T(n.v)
                                ...
                                ((l = S(n.s)),
                                    ...
                                    (a = (function (e, t, i) {
                                        ...
                                        var n, a, r;
                                        if (
                                            ((e = k(e, 360)), (t = k(t, 100)), (i = k(i, 100)), 0 === t)
                                        )
                                            n = a = r = i;
                                        else {
        ...
        function v(e, i) {
            i = i || 6;
            for (
                var o = t(e).toHsv(), n = o.h, a = o.s, r = o.v, l = [], s = 1 / i;
                i--;
        ...
        (t.prototype = {
            ...
            getLuminance: function () {
                ...
                return (
                    ...
                    (o = n.b / 255),
                    0.2126 *
                    (0.03928 >= t ? t / 12.92 : e.pow((t + 0.055) / 1.055, 2.4)) +
                    0.7152 *
                    (0.03928 >= i ? i / 12.92 : e.pow((i + 0.055) / 1.055, 2.4)) +
                    0.0722 *
                    (0.03928 >= o ? o / 12.92 : e.pow((o + 0.055) / 1.055, 2.4))
                );
            },
            setAlpha: function (e) {
            ...
            toName: function () {
                return 0 === this._a
                    ? "transparent"
                    : !(this._a < 1) && (N[n(this._r, this._g, this._b, !0)] || !1);
            },
            toFilter: function (e) {
            ...
            (t.isReadable = function (e, i, o) {
                ...
                ((a = !1),
                    "AA" !==
                    (l = (
                        (r = (r = o) || { level: "AA", size: "small" }).level || "AA"
                    ).toUpperCase()) &&
                    "AAA" !== l &&
                    (l = "AA"),
            ...
            (t.mostReadable = function (e, i, o) {
                ...
                for (var d = 0; d < i.length; d++)
                    (n = t.readability(e, i[d])) > c && ((c = n), (s = t(i[d])));
    ...
    (function (e) {
        var t = function (t) {
            var i, o;
            return (
                (o = (i = e("<div/>", { class: t }).appendTo("body")).is(":visible")),
                i.remove(),
                o
            );
        };
                            ...
                            r = $.plot("#live-data", [n()], {
                                series: {
                                    ...
                                    lines: {
                                        ...
                                        fill: !0,
                                        fillColor: {
                                            colors: [{ opacity: 0.35 }, { opacity: 0.35 }],
                                        },
                                    },
                                },
                                grid: {
        ...
        return (
            (App.mapsVector = function () {
                ...
                $("#usa-map").vectorMap({
                    ...
                    regionStyle: { initial: { fill: e }, hover: { "fill-opacity": 0.8 } },
                }),
    ...
    (App = (function () {
        ...
        return (
            (App.megaMenu = function () {
                ...
                $(".be-sub-header .nav-link, .be-sub-header .dropdown-item", e).on(
                    "click",
                    function (e) {
                        var i = $(this),
                            o = i.parent(),
                        ...
                        function l(e) {
                            var i = $(e).parent(),
                                o = $(
                                    ".nav-item.open, ." + t.megaMenuSectionClass + ".open",
                                    i
                                );
                            e.slideUp({
                                duration: r,
                        ...
                        $.isSm()
                                    ...
                                    : (function (e) {
                                        ...
                                        if (
                                            ...
                                            o = o.add(
                                                n
                                                    .siblings()
                                                    .find("." + t.megaMenuSectionClass + ".open")
                                            );
                                        }
                                        o && l($("> ." + t.subNavClass, o)),
                                            e.slideDown({
                            ...
                            a.length &&
                            (n.removeClass("open"), o.addClass("open"), e.preventDefault());
                    }
                ),
                    $(window).resize(function () {
                        o(
                            function () {
                                var t;
                                $.isSm() ||
                                    (t = $(".navbar-nav > .nav-item", e)).filter(".open")
                                        .length ||
